...
| 降AI | 硬着头皮改套话、调句式 | 自动扫描句长/连接词/套话 → 逐段修复 |
...
│   ├── humanize_constraints.md       #   D1-D5 降AI写作约束
│   └── humanize_pass.md              #   独立降AI改写流程
│
├── tools/                            # Python 工具脚本
